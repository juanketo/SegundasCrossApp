...
export const agreReinoScreen = ({navigation}) => {
  ...
  const { nombre, tipo, gobernante, ubicacion } = form;
  ...
  const handleSubmit = async () => {
    if(form.nombre === "" || form.tipo === "" || form.gobernante === ""|| form.ubicacion === ""){
      ...
      await adventureapi.post("/reinos", form);
      setForm({
        nombre: "",
        tipo: "",
        gobernante: "",
    ...
    >
      <View style={styles.mainContainer}>
        <View style={styles.container}>
          <Text style={styles.titulo}>Nuevo Reino</Text>
          <View>
            ...
            <Pressable
              ...
              <Text style={styles.buttonText}>Agregar Reino</Text>
            </Pressable>
          </View>
        </View>
