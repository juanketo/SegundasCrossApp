...
export const personajesScreen = ({ navigation }) => {
    ...
    >
      <View style={styles.mainContainer}>
        ...
        <View style={styles.container}>
          <Text style={styles.titulo}>PERSONAJES HORA DE AVENTURA</Text>
        </View>
        <View style={{ flexDirection:'row', flexWrap: "wrap", gap: 15,}}>
          <CardPerso navigation={navigation} />
        </View>
        <View style={styles.container}>
          <Pressable
            style={({ pressed }) => [
            ...
            onPress={() => navigation.navigate("AgrePersoScreen")}
          >
